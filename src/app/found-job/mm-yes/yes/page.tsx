...
export default function MMYesYesPage() {
				...
				<div className="grid grid-cols-1 md:[grid-template-columns:minmax(0,1fr)_400px] gap-0 md:gap-8 p-6 md:p-6 md:items-start">
					<div className="order-2 md:order-1">
						...
						<div className="mt-3 space-y-3">
							<label className="flex items-center gap-3">
								...
								<span className="text-[14px] text-[#62605C]">Yes</span>
							</label>
						</div>

						<p className="mt-4 text-[14px]  text-[#41403D]">What visa will you be applying for?*</p>
						...
						<div className="border-t border-gray-200 pt-4 mt-4">
							<button
								disabled={!isValid}
								onClick={async () => { if (!isValid) return; await finalizeCancellation({ reason: "MM-YES yes lawyer - visa: " + visa.trim(), accepted: false }); router.push("/found-job/complete-yes"); }}
					...
					<div className="order-1 md:order-2 hidden md:flex md:justify-end md:items-start">
						<div className="relative w-[400px] h-[335px] rounded-[12px] overflow-hidden">
							<img src="/OY2.png" alt="City image" />
						</div>
					</div>
				</div>
			</div>
